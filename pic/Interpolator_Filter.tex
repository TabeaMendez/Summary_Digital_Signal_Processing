...
\begin{tikzpicture}[>=latex, scale=0.9]
      ...
      \draw[->][line width=0.75](-6,0)--(6,0)node[below]{$\omega'$};
...
% 		\draw[line width=2, blueT](-0.6*4,0)--(0.6*4,-0);
      ...
      \draw[line width=0.75](-1.2*0.5,0.2)--(-1.2*0.5,-0.2)node[below]{-$\pi$\footnotesize$/L\;\;\;$};		
      \draw[line width=0.75](2*1.2,0.2)--(2*1.2,-0.2)node[below,fill=white]{ $\pi$};
      \draw[line width=0.75](-2*1.2,0.2)--(-2*1.2,-0.2)node[below,fill=white]{-$\pi$};
      \draw[line width=0.75](4*1.2,0.2)--(4*1.2,-0.2)node[below]{ $2\pi$};
      \draw[line width=0.75](-4*1.2,0.2)--(-4*1.2,-0.2)node[below]{ -$2\pi$};
